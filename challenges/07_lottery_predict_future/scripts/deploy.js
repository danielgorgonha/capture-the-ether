...
async function main() {
  console.log("🚀 Iniciando deploy do PredictTheFutureChallenge...\n");
  ...
  console.log("📦 Deployando PredictTheFutureChallenge (enviando 1 ether)...");
  ...
  console.log("\n💡 Próximo passo: Execute o exploit para fazer lock do palpite e depois settle");
}

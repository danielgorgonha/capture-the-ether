...
/**
 * @title GuessTheNewNumberChallengeFixed
 * @notice Versão corrigida do GuessTheNewNumberChallenge usando commit-reveal
 ...
 */
contract GuessTheNewNumberChallengeFixed {

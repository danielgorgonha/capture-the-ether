...
/**
 * @title GuessTheRandomNumberChallengeFixed
 * @notice Versão corrigida do GuessTheRandomNumberChallenge usando commit-reveal
 * @dev NOTA: Para produção, use Chainlink VRF. Esta é uma versão simplificada.
 * 
 * CORREÇÕES APLICADAS:
 * 1. Removido uso de dados públicos de blocos (block.blockhash, now)
 ...
 */
contract GuessTheRandomNumberChallengeFixed {

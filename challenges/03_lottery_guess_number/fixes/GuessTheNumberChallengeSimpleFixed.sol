...
/**
 * @title GuessTheNumberChallengeSimpleFixed
 * @notice Versão corrigida simplificada (sem Chainlink VRF)
 * @dev Usa esquema commit-reveal para aleatoriedade
 * 
 * CORREÇÕES APLICADAS:
 * 1. Removido valor hardcoded (answer = 42)
 * 2. Implementado esquema commit-reveal
 ...
 */
contract GuessTheNumberChallengeSimpleFixed {
